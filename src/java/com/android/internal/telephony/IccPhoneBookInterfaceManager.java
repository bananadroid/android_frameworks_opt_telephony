...
public class IccPhoneBookInterfaceManager {
     ...
     *        Set both oldTag and oldPhoneNumber to "" means to replace an
     ...
     * @param newPhoneNumber adn number ot be stored
     * @param oldPhoneNumber adn number to be replaced
     *        Set both oldTag, oldPhoneNumber, oldEmail and oldAnr to ""
     *        means to replace an empty record, aka, insert new record
     *        Set both newTag, newPhoneNumber, newEmail and newAnr ""
